...
# --- Settings ---
TOKEN = '7536820296:AAFqzXblVtvwpZqtM_ayNGOIgAktCVLI6f4'
CHANNEL_USERNAME = '@lbtest12'
BOT_USERNAME = 'LBBASUGUZAR_bot'
OWNER_USERNAMES = ['tmecontact', 'mxolmurod']
DATA_FILE = 'data.json'
...
def start(update: Update, context: CallbackContext):
    ...
    if is_owner:
        text = (
            "\U0001F44B Welcome!\n\n"
            f"Type @{BOT_USERNAME} ❤\ufe0f Like in any chat to create a likeable post.\n"
            f"The message is forwardable and users must subscribe to {CHANNEL_USERNAME} to vote. \u2705"
        )
